...
const selectorsAndEvents = {
  selectors() {
    ...
    this.optionsOrder = document.querySelector("[data-order_options]")
  },
  events() {
    this.c_player.addEventListener("click", this.removeBlurs)
    this.btnOrder.addEventListener("click", this.showOptionsOrder)
    this.optionsOrder.addEventListener("change", this.orderActions)
    this.audio.onerror = (e) => this.audioError(e, "next")
    ...
    this.controls.addEventListener("touchend", this.stopSpeedAudio)
